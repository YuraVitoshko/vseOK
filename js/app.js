 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        var smooth_scroll_polyfills_min = __webpack_require__(144);
        ...
        function initSliders() {
            ...
            if (document.querySelector(".product-card__body")) {
                new swiper_core_Swiper(".product-card__slider-small", {
                ...
                new swiper_core_Swiper(".product-card__slider-big", {
...
***************************************************************************** */
        ...
        var lg_thumbnail_min = __webpack_require__(528);
